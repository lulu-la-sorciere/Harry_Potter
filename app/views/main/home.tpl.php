<div class="content">
    <div class="container">
        ...
        <div class="paragraphe">
            ...
            <p>
                Harry Potter est une série littéraire de low fantasy écrite par l'auteure britannique J. K. Rowling.
            </p>
            <p>
        ...
        <div>
            <a  href="<?= $router->generate('main-home') ?>"><img class="home" src="<?= $assetsBaseUri ?>/images/Hogwart.png" alt="Hogwart"></a>
        </div>
        <div class="paragraphe">
            <p>
